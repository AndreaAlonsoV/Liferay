package com.iconsulto.miTablero.actividades.constants;
 ...
 */
public class MiTableroActividadesPortletKeys {

	public static final String MITABLEROACTIVIDADES = "miTableroActividades_MiTableroActividadesPortlet";
	...
	private MiTableroActividadesPortletKeys() {
		/** Constructor privado **/
	}
